...
$matrix = [
    ...
    [
        ...
        'writeup' => true,
        'poc'     => true,
        'note'    => '路径穿越 / 黑名单单次替换可双写绕过 / 白名单映射 + 越界兜底',
    ],
    [
        'name'    => 'PHP 反序列化（POP 链）',
        'href'    => 'unserialize/low.php',
        'levels'  => ['low', 'medium', 'high'],
        'writeup' => true,
        'poc'     => true,
        'note'    => '任意类任意属性 / 类名黑名单可用大小写绕过 / allowed_classes 白名单',
    ],
    [
        'name'    => 'XXE（XML 外部实体）',
        'href'    => 'xxe/low.php',
        ...
        'writeup' => true,
        'poc'     => true,
        'note'    => '内联实体读文件 / 实体声明挪到外部 DTD 绕过黑名单 / 禁外部实体加载器',
    ],
    [
        'name'    => 'JWT（签名绕过）',
        'href'    => 'jwt/low.php',
        ...
        'writeup' => true,
        'poc'     => true,
        'note'    => 'alg:none 放行 / 弱密钥可爆破后伪造签名 / 算法白名单 + 高熵密钥',
    ],
    [
        'name'    => 'CSRF（跨站请求伪造）',
        'href'    => 'csrf/low.php',
        ...
        'writeup' => true,
        'poc'     => true,
        'note'    => '零防护 / Referer 可被攻击者去掉或子串包含 / 会话绑定的一次性 token',
    ],
    [
        'name'    => 'SSTI（模板注入）',
        'href'    => 'ssti/low.php',
        ...
        'writeup' => true,
        'poc'     => true,
        'note'    => '表达式直接求值 / 反引号绕过括号黑名单 / 变量白名单且无 eval',
    ],
    [
        'name'    => '越权（水平越权 / IDOR）',
        'href'    => 'idor/low.php',
